! function () {
	...
	a.push({
		...
		familyName: "cera-round-pro",
		className: "cera-round-pro",
		weight: "700",
		style: "normal"
	}), a.push({
		familyName: "cera-round-pro",
		...
		useUrl: "use.fortawesome.com/kits/1ce05b4b/publications/128039",
		code: "1ce05b4b",
		familyName: "FontawesomeComV6",
		prefix: "fac",
		testString: "&",
		typefaces: a
	}
...
! function () {
	...
	var f = function (a) {
			...
			var b = new FontFace("t", 'url( "data:application/font-woff2;base64," ) format( "woff2" )', {});
		...
		h = {
			observe: function (a, b) {
				for (var c = b.prefix, d = function (a) {
						...
						i("loading"), new e(a.familyName).load(a.testString).then(function () {
							i("ready"), j("loading")
						}, function () {
							i("failed"), j("loading")
						})
	...
	try {
		if (window.FortAwesomeConfig) {
			var j = window.FortAwesomeConfig,
				...
				o = j.typefaces,
				p = c.bind(c, m);
			j.autoA11y.enabled && (a(p), b(p)), woffCSSFilename = f ? "woff2.css" : "woff.css", cssFilename = g.isIE(8, "lte") ? "eot.css" : woffCSSFilename, cssUrl = "https://" + k + "/" + cssFilename, j.asyncLoading.enabled ? i.loadAsync(cssUrl, n) : i.load(cssUrl), h.observe([{
				familyName: l,
				testString: n
			}], {
				prefix: m + "-events-icons"
			}), h.observe(o, {
				prefix: m + "-events-typefaces"
			})
		}
	} catch (q) {}
}();